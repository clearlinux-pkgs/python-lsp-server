...
%prep
%setup -q -n python-lsp-server-1.0.1
cd %{_builddir}/python-lsp-server-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619808332
...
cp %{_builddir}/python-lsp-server-1.0.1/LICENSE %{buildroot}/usr/share/package-licenses/python-lsp-server/c0a4218ed5c81a62f45a9cc14735457e71102cee
